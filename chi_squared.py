...
def broadband(data, model, cov_matrix, space='config'):
...
def chi2(theta, data, cov_matrix, linear_template, mu , S_r, iso, sigmas=None, space='config'):
    ...
    if space=='config':
        ...
        bb0, bb2, _ = broadband([s, xi0, xi2], [xi0m, xi2m], cov_matrix, space='config')
        ...
        bb0, bb2, _ = broadband([k_data, ps0, ps2], [ps0m, ps2m], cov_matrix, space='fourier')
...
def loglike(theta, data, cov_matrix, linear_template, S_r, iso, sigmas=None, space='config'):
    return -0.5 * chi2(theta, data, cov_matrix, linear_template, S_r, iso, sigmas, space)

def logpost(theta, data, cov_matrix, linear_template, S_r, iso, sigmas=None, space='config'):
    '''The natural logarithm of the posterior.'''
    return logprior(theta, sigmas) + loglike(theta, data, cov_matrix, linear_template, S_r, iso, sigmas, space)
